...
export default class Auth extends Base {
  ...
  verifyPhoneNumber(phoneNumber: string): Promise<Object> {
    return this._interceptUserValue(FirebaseAuth.verifyPhoneNumber(phoneNumber));
  }
   ...
   * @return {Promise}           A promise resolved upon completion
   */
  signInWithPhone(verificationId: string, verificationCode: string): Promise<Object> {
    return this._interceptUserValue(FirebaseAuth.signInWithPhoneCredential(verificationId, verificationCode));
  }
